...
export const mdxComponents: MDXComponentsProps = {
  ...
  h1: ({ children, ...props }: { children: ReactNode }) => (
    <h1
      className="text-3xl md:text-4xl font-bold tracking-tight mb-6 mt-8 first:mt-0"
      {...props}
    >
      {children}
    </h1>
  ...
  h2: ({ children, ...props }: { children: ReactNode }) => (
    <h2
      className="text-2xl md:text-3xl font-bold tracking-tight mb-4 mt-8"
      {...props}
    >
      {children}
    </h2>
  ...
  h3: ({ children, ...props }: { children: ReactNode }) => (
    <h3
      className="text-xl md:text-2xl font-bold tracking-tight mb-3 mt-6"
      {...props}
    >
      {children}
    </h3>
  ...
  blockquote: ({ children, ...props }: { children: ReactNode }) => (
    <blockquote
      className="border-l-4 border-gray-300 dark:border-gray-600 pl-6 my-6 italic text-lg"
      {...props}
    >
      {children}
    </blockquote>
  ...
  pre: ({ children, ...props }: { children: ReactNode }) => (
    <pre
      className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 overflow-x-auto my-6 text-sm"
      {...props}
    >
      {children}
    </pre>
