...
function Contact() {
  return (
    <div id="contact" className="container mx-auto px-4 py-8 mt-10">
      ...
      <p className="mb-4 text-lg text-white max-w-xl max-h-xl overflow-hidden text-justify leading-relaxed ">
        ...
        opportunities, as well as collaborating on open-source
        projects. Feel free to contact me or simply say hello!
      </p>
